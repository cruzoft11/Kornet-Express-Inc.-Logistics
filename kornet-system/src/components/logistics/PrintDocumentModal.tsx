...
export default function PrintDocumentModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 overflow-y-auto print:p-0 print:bg-white">
      <div className="bg-white text-slate-900 rounded-xl shadow-2xl w-full max-w-4xl border border-slate-300 overflow-hidden flex flex-col max-h-[90vh] print:max-h-none print:shadow-none print:border-none print:w-full">
        {/* Modal Toolbar (hidden when printing) */}
        <div className="px-6 py-3 bg-slate-800 text-white flex items-center justify-between print:hidden border-b border-slate-700">
          <div className="flex items-center gap-2">
            <span className="material-symbols-outlined text-blue-400">print</span>
            <span className="font-bold text-sm tracking-wide">{title}</span>
            <span className="px-2 py-0.5 rounded text-[10px] font-black uppercase bg-blue-900/80 text-blue-200 border border-blue-700">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-4 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold shadow flex items-center gap-1.5 transition-colors"
            >
            ...
            <button
              onClick={handlePrint}
              className="px-4 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold shadow flex items-center gap-1.5 transition-colors"
            >
